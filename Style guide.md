...
Name assigning
--------------
*	A name assigned to a variable, class or function can contain more than one word. In this case any new word after the first word will begin with a capital letter. 
